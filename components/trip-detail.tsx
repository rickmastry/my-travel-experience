...
export default function TripDetailClient({ trip }: TripDetailClientProps) {
    ...
    return (
        <div className="container mx-auto px-4 py-8 space-y-8">{trip.imageUrl && (
            ...
            <div className="bg-white p-6 shadow rounded-lg flex flex-cols md:flex-row justify-between items-start md:items-center">
                <div>
                    <h1 className="text-4xl font-extrabold text-gray-900">{trip.title}</h1>
                    <div className="flex items-center text-gray-500 mt-2">
                        <Calendar className="h-5 w-5 mr-2" /> <span>{trip.startDate.toLocaleDateString()} - {trip.endDate.toLocaleDateString()}</span>
                    </div>
                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p className="tes-sm text-gray-500"></p>
